...
from pug.all_components import Key_Direction_Controls, Motion_Zone, Key_Spawn,\
    On_Destroy_Sound, Spawn_On_Destroy, Multiple_Lives, Fade, Takes_Damage
### End import autocode ###

### FlyAroundPlayerClass autocode ###
class FlyAroundPlayerClass(PigSprite):
    image = 'art\\pug.png'
    layer = 'Background'
    def on_create(self):
        ...
        self.components.add( Takes_Damage(
                invincible_time=2,
                group='player') )
### End FlyAroundPlayerClass autocode ###
