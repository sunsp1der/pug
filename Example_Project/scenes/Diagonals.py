...
# "Diagonals" autocode #
########################
class Diagonals(PugScene):    # Sprites etc.
    def enter(self):
        ...
        pugsprite_instance_4.position.x = 550.0
        pugsprite_instance_4.position.y = 400.0
        ...
        pugsprite_instance_6.position.y = 200.0
        ...
        pugsprite_instance_8.position.x = 400.0
        pugsprite_instance_8.position.y = 350.0

        pugsprite_instance_9 = PugSprite()
        pugsprite_instance_9.image = 'art/sprite.png'
        pugsprite_instance_9.layer = 'foo'
        pugsprite_instance_9.position.x = 150.0
        pugsprite_instance_9.position.y = 100.0

        pugsprite_instance_10 = PugSprite()
        pugsprite_instance_10.image = 'art/sprite.png'
        pugsprite_instance_10.layer = 'bar'
        pugsprite_instance_10.position.x = 450.0
        ...
        pugsprite_instance_11.position.x = 250.0
        pugsprite_instance_11.position.y = 100.0

        pugsprite_instance_12 = PugSprite()
        pugsprite_instance_12.image = 'art/sprite.png'
        pugsprite_instance_12.layer = 'foo'
        pugsprite_instance_12.position.x = 350.0
        pugsprite_instance_12.position.y = 300.0
        ...
        pugsprite_instance_19.position.x = 450.0
        pugsprite_instance_19.position.y = 400.0
