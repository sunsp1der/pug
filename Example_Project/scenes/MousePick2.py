...
class MousePick2(PugScene):
    ...
    def enter(self):
        ...
        pugsprite_instance.position.x = 100.0
        pugsprite_instance.position.y = 50.0

        pugsprite_instance_2 = PugSprite()
        pugsprite_instance_2.image = 'art/sprite.png'
        pugsprite_instance_2.layer = 'foo'
        pugsprite_instance_2.position.x = 150.0
        pugsprite_instance_2.position.y = 100.0

        pugsprite_instance_3 = PugSprite()
        pugsprite_instance_3.image = 'art/sprite.png'
        pugsprite_instance_3.layer = 'foo'
        pugsprite_instance_3.position.x = 200.0
        pugsprite_instance_3.position.y = 150.0
        ...
        pugsprite_instance_9.layer = 'foo'
        pugsprite_instance_9.position.x = 500.0
        pugsprite_instance_9.position.y = 450.0

        pugsprite_instance_10 = PugSprite()
        pugsprite_instance_10.image = 'art/sprite.png'
        pugsprite_instance_10.layer = 'foo'
        pugsprite_instance_10.position.x = 550.0
        pugsprite_instance_10.position.y = 500.0

        pugsprite_instance_11 = PugSprite()
        pugsprite_instance_11.image = 'art/sprite.png'
        pugsprite_instance_11.layer = 'bar'
        pugsprite_instance_11.position.x = 200.0
        pugsprite_instance_11.position.y = 50.0
        ...
        pugsprite_instance_12.position.y = 100.0

        pugsprite_instance_13 = PugSprite()
        pugsprite_instance_13.image = 'art/sprite.png'
        pugsprite_instance_13.layer = 'bar'
        pugsprite_instance_13.position.x = 300.0
        pugsprite_instance_13.position.y = 150.0

        thirddown = PugSprite(gname='thirddown')
        thirddown.image = 'art/sprite.png'
        thirddown.layer = 'bar'
        thirddown.position.x = 360.0
        thirddown.position.y = 200.0

        pugsprite_instance_14 = PugSprite()
        pugsprite_instance_14.image = 'art/sprite.png'
        pugsprite_instance_14.layer = 'bar'
        pugsprite_instance_14.position.x = 400.0
        pugsprite_instance_14.position.y = 250.0

        pugsprite_instance_15 = PugSprite()
        pugsprite_instance_15.image = 'art/sprite.png'
        pugsprite_instance_15.layer = 'bar'
        pugsprite_instance_15.position.x = 450.0
        pugsprite_instance_15.position.y = 300.0

        pugsprite_instance_16 = PugSprite()
        pugsprite_instance_16.image = 'art/sprite.png'
        pugsprite_instance_16.layer = 'bar'
        pugsprite_instance_16.position.x = 500.0
        ...
        pugsprite_instance_17.position.x = 550.0
        pugsprite_instance_17.position.y = 400.0

        pugsprite_instance_18 = PugSprite()
        pugsprite_instance_18.image = 'art/sprite.png'
        pugsprite_instance_18.layer = 'bar'
        pugsprite_instance_18.position.x = 600.0
        pugsprite_instance_18.position.y = 450.0

        pugsprite_instance_19 = PugSprite()
        pugsprite_instance_19.image = 'art/sprite.png'
        pugsprite_instance_19.layer = 'bar'
        pugsprite_instance_19.position.x = 650.0
        pugsprite_instance_19.position.y = 500.0
