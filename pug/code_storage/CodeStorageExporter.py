...
"""
    ...
    def export(self, filename=None, obj=None, asClass=None, storageDict=None,
               test=None):
        """export(filename, obj=None, asClass=None, storageDict=None,test=None)
    
Export auto-generated code that will create 'obj'

filename: the file to write to. If filename is None, the code text will be 
    stored in the CodeStorageExporter's 'code' attribute.
...
test: If True, the created code will be executed to test if it works properly.
    ...
    objects or settings. If None (default) this value will be set to same value
    as asClass
"""
...
the code appears before first autocode block. A file with no autocode is 
considered to have no usercode.
"""
        user_code_dict = {}
    ...
    def inject_usercode(self, code, user_code_dict):
        """extract_usercode( code, user_code_dict)->code with user_code
