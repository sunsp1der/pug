...
#            quit()
        ...
        if channelVoiceMessages.has_value(y):
            ...
            if (self.type == "PROGRAM_CHANGE" or
                ...
                self.data = z
                if prints < 10: print self.type, self.channel, self.data
                return str[2:]
            else:
                self.pitch = z
                ...
                if prints < 10: print self.type, self.channel, self.pitch, self.velocity
                return str[3:]
            ...
            if self.type == "LOCAL_CONTROL":
                ...
                self.data = ord(str[2])
            if prints < 10: print self.type, self.data                
            return str[3:]
