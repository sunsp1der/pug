...
class Midi_Demo(PigScene):
    def on_enter(self):
        ...
        pigsprite_instance_2.components.add( Spawn_On_Midi(
                channel_range=(0, 1),
                rapid_fire=False,
                spectrum_range=(48, 60),
                spawn_object='Petal',
        ...
        pigsprite_instance_3.components.add( Spawn_On_Midi(
                channel_range=(1, 2),
                rapid_fire=False,
                spectrum_range=(48, 60),
                spawn_object='Petal',
        ...
        pigsprite_instance_4.components.add( Spawn_On_Midi(
                channel_range=(2, 3),
                rapid_fire=False,
                spectrum_range=(48, 60),
                spawn_object='Petal',
        ...
        pigsprite_instance_5.components.add( Spawn_On_Midi(
                channel_range=(3, 4),
                rapid_fire=False,
                spectrum_range=(48, 60),
                spawn_object='Petal',
